    ...
    <div className="h-full">
      <ScrollArea className={"h-full rounded-md"}>
        <div className="relative min-h-full">
          <div className="absolute inset-0 bg-linear-to-b from-[#5038a0]/80 via-zinc-900/80 to-zinc-900 pointer-events-none"></div>
          <div className="relative z-10">
            ...
            <div className="px-6 pb-4 flex items-center gap-6">
              <Button
                ...
                size={"icon"}
                className={
                  "w-14 h-14 rounded-full bg-green-500 hover:bg-green-400 hover:scale-105 transition-all cursor-pointer"
                }
              >
                {isPlaying &&
